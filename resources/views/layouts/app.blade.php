...
<head>
    ...
    <title>{{ $title }} - Laundry Online</title>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                    style="opacity: .8">
                <span class="brand-text font-weight-light">Laundry Online</span>
            </a>
            ...
            <button class="btn btn-sidebar">
              <i class="fas fa-search fa-fw"></i>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="/order" class="nav-link {{ $title == 'Data Order' ? 'active' : '' }}">
                                <i class="nav-icon fas fa-shopping-cart"></i>
                                <p>Order</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/status" class="nav-link {{ $title == 'Data Status' ? 'active' : '' }}">
                                <i class="nav-icon fas fa-clock"></i>
                                <p>Status</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/komentar" class="nav-link {{ $title == 'Data Komentar' ? 'active' : '' }}">
