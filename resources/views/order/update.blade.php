                    ...
                    <form method="POST" action="/order/{{ $order->id }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('user_id') is-invalid @enderror" id="user_id"
                                name="user_id" placeholder="{{ $order->user_id }}" value="{{ $order->user_id }}">
                            @error('user_id')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('toko_id') is-invalid @enderror" id="toko_id"
                                name="toko_id" placeholder="{{ $order->toko_id }}" value="{{ $order->toko_id }}">
                            @error('toko_id')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('alamat') is-invalid @enderror" id="alamat"
                                name="alamat" placeholder="{{ $order->alamat }}" value="{{ $order->alamat }}">
                            @error('alamat')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('provinsi') is-invalid @enderror" id="provinsi"
                                name="provinsi" placeholder="{{ $order->provinsi }}" value="{{ $order->provinsi }}">
                            @error('provinsi')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('kota') is-invalid @enderror" id="kota"
                                name="kota" placeholder="{{ $order->kota }}" value="{{ $order->kota }}">
                            @error('kota')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('kecamatan') is-invalid @enderror" id="kecamatan"
                                name="kecamatan" placeholder="{{ $order->kecamatan }}"
                                value="{{ $order->kecamatan }}">
                            @error('kecamatan')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('kelurahan') is-invalid @enderror" id="kelurahan"
                                name="kelurahan" placeholder="{{ $order->kelurahan }}"
                                value="{{ $order->kelurahan }}">
                            @error('kelurahan')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('jumlah_qty') is-invalid @enderror"
                                id="jumlah_qty" name="jumlah_qty" placeholder="{{ $order->jumlah_qty }}"
                                value="{{ $order->jumlah_qty }}">
                            @error('jumlah_qty')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('total') is-invalid @enderror" id="total"
                                name="total" placeholder="{{ $order->total }}" value="{{ $order->total }}">
                            @error('total')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="time" class="form-control @error('waktu_pengambilan') is-invalid @enderror"
                                id="waktu_pengambilan" name="waktu_pengambilan"
                                placeholder="{{ $order->waktu_pengambilan }}" value="{{ $order->waktu_pengambilan }}">
