            ...
            <div class="card-body">
                        <form method="POST" action="/status/{{ $status->id }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('user_id') is-invalid @enderror" id="user_id" name="user_id" placeholder="{{ $status->user_id }}" value="{{ $status->user_id }}">
                                @error('user_id')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('toko_id') is-invalid @enderror" id="toko_id" name="toko_id" placeholder="{{ $status->toko_id }}" value="{{ $status->toko_id }}">
                                @error('toko_id')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
